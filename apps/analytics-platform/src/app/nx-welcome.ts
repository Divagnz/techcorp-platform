      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build analytics-platform
<span># Test</span>
nx test analytics-platform
<span># Lint</span>
nx lint analytics-platform
<span># Run them together!</span>
nx run-many -p analytics-platform -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project analytics-platform</pre>
          </details>
