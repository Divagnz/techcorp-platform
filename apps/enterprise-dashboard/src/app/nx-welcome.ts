      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build enterprise-dashboard
<span># Test</span>
nx test enterprise-dashboard
<span># Lint</span>
nx lint enterprise-dashboard
<span># Run them together!</span>
nx run-many -p enterprise-dashboard -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project enterprise-dashboard</pre>
          </details>
